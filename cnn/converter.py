"""Converts the .csv to images; taken from https://www.kaggle.com/code/shalamov/csv-to-images"""
import csv
...
csv_File_Path = "../data/A_Z Handwritten Data/A_Z Handwritten Data.csv"
